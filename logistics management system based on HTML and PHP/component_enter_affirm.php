...
<html>
   <?php
        ...
        $query="select * from component_enter_affrim;";
   ...
   <div class="row clearfix">
      <div class="col-md-12 column">
         ...
         <div class="row clearfix">
            ...
            <div class="col-md-10 column">
            <h3>component_enter_affirm_table</h3>
...
// JavaScript Document
	...
	function check(){
		...
		{
			var box = rows[i].cells[7].childNodes[0];
			if(box.checked==true){
				rows[i].cells[6].innerHTML="yes";
				postPara="purchase_id="+rows[i].cells[1].innerHTML;
				AJAX('component_enter_affirm_exe.php',postPara,function(str){
					alert(str);		
				});
			}
		}
