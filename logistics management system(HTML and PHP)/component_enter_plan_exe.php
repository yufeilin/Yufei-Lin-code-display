<?php 
	...
	$query="insert into component_enter_affrim values('".$provider_name."','".$purchase_id."','".	$component_id."','".$component_name."','".$component_standard."','".$component_unit."','".$enter_count."','hh',0);";
	$result=$db->query($query);
	if($result){
