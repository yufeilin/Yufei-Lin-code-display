...
public class PieceInfoController : MonoBehaviour
{
    ...
    public bool GetAssistAttackFlag()
    {
        return AssistAttack;
    }

    public bool GetAssistDefendFlag()
    {
        return AssistDefend;
    }
    ...
    public int GetPieceCostMineral()
    {
        return PieceCostMineral;
    }

    public int GetPieceCostGas()
    {
        return PieceCostGas;
    }

    public void SetPieceCostMineral(int NewPieceCostMineral)
    {
        PieceCostMineral = NewPieceCostMineral;
    }

    public void SetPieceCostGas(int NewPieceCostGas)
    {
        PieceCostGas = NewPieceCostGas;
    }
